...
var author$project$Home$Guest = {$: 'Guest'};
var author$project$Home$LIdle = {$: 'LIdle'};
var author$project$Home$OverlayHidden = {$: 'OverlayHidden'};
var author$project$Home$GotSearchResults = function (a) {
	return {$: 'GotSearchResults', a: a};
};
var author$project$Home$Searchres = F6(
	function (id, name, link, time, places, state) {
		return {id: id, link: link, name: name, places: places, state: state, time: time};
	});
var author$project$Home$Sresunselected = {$: 'Sresunselected'};
var author$project$Home$Places = function (free) {
	return {free: free};
};
...
var author$project$Home$decodePlaces = A2(
...
var author$project$Home$getExamples = elm$http$Http$get(
	{
...
var author$project$Home$LSuccess = function (a) {
	return {$: 'LSuccess', a: a};
};
					...
					if (result.$ === 'Ok') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									state: author$project$Home$LSuccess(arr)
								}),
							elm$core$Platform$Cmd$none);
					} else {
						var err = result.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									state: author$project$Home$LErr(err)
								}),
							elm$core$Platform$Cmd$none);
					}
				case 'UpdateEmail':
				...
				case 'Togglewatch':
					...
					if (_n6.$ === 'LoggedIn') {
						...
						var $temp$msg = author$project$Home$ShowOverlay(elm$core$Maybe$Nothing),
							...
							model,
							{
								selectedCourse: elm$core$Maybe$Just(index)
							});
						msg = $temp$msg;
						model = $temp$model;
						continue update;
...
var author$project$Home$viewEmptyResults = _List_fromArray(
	[
		A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('emptyresults')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$text('No results were found.')
					]))
			]))
	]);
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('result-btn-icon ' + faclass)
								]),
							_List_Nil)
						]));
			});
		var linkAtt = _List_fromArray(
			[
				elm$html$Html$Attributes$rel('noopener'),
				elm$html$Html$Attributes$target('_blank'),
				elm$html$Html$Attributes$href('https://' + sresult.link)
			]);
		var freePlacesText = function () {
			var _n1 = sresult.places.free;
			switch (_n1) {
				case 0:
					return 'Keine Plätze frei';
				case 1:
					return 'Ein Platz frei';
				default:
					return elm$core$String$fromInt(sresult.places.free) + ' Plätze frei';
			}
		}();
		var actionBtn = function () {
			if (!sresult.places.free) {
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('result-btn-icon fas fa-chevron-right')
								]),
							_List_Nil)
						]));
			}
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('result-left')
						]),
					_List_fromArray(
						[
							A2(
							...
							_Utils_ap(
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Attributes$title('In neuem Tab öffnen')
									])),
							_List_fromArray(
								[
									elm$html$Html$text(sresult.name + (' (' + (sresult.id + ')'))),
									A2(
									elm$html$Html$i,
									_List_fromArray(
										[
											elm$html$Html$Attributes$class('fas fa-external-link-square-alt')
										]),
									_List_Nil)
								])),
							A2(
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('result-time')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_Nil),
									elm$html$Html$text(sresult.time)
								]))
						])),
					A2(
					elm$html$Html$div,
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('result-right')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('result-places')
								]),
							_List_fromArray(
								[
									elm$html$Html$text(freePlacesText)
								])),
							actionBtn
						]))
				]));
...
var author$project$Home$viewSearchresults = function (lstate) {
	switch (lstate.$) {
		case 'LIdle':
			return _List_fromArray(
				[
		...
		case 'LBusy':
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('loadingtext')
						]),
					_List_fromArray(
						[
							elm$html$Html$text('...')
		...
		case 'LErr':
			...
			return _List_fromArray(
				[
					elm$html$Html$text('Error occured. Please try again.'),
					A2(
					elm$html$Html$p,
					_List_Nil,
					_List_fromArray(
		...
		default:
			var sresults = lstate.a;
			var _n1 = elm$core$Array$length(sresults);
			if (!_n1) {
				return author$project$Home$viewEmptyResults;
			} else {
				return elm$core$Array$toList(
					A2(elm$core$Array$indexedMap, author$project$Home$viewResult, sresults));
			}
	}
};
...
var author$project$Home$viewHead = F2(
	function (showExplaination, login) {
		var loggedInHtml = function () {
			if (login.$ === 'LoggedIn') {
				var email = login.a;
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('fade-msg')
							]),
						_List_fromArray(
							[
								elm$html$Html$text('Eingeloggt!')
							])),
						A2(
						elm$html$Html$span,
						_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Events$onClick(
								author$project$Home$ShowOverlay(elm$core$Maybe$Nothing))
							]),
						_List_fromArray(
							[
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('expl-bold')
						]),
					_List_fromArray(
						[
							elm$html$Html$text('Willkommen bei USIWatch.')
						])),
					A2(
					elm$html$Html$p,
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('expl-text')
						]),
					_List_fromArray(
						[
							elm$html$Html$text('Hier kannst du nach Kursen des USI Graz suchen und dich benachrichtigen lassen, wenn Plätze frei werden.')
						]))
				]));
	});
...
var author$project$Home$view = function (model) {
	var doc = function (html) {
		return {body: html, title: 'usiwatch'};
	};
	return doc(
		_List_fromArray(
			[
				A2(author$project$Home$viewOverlay, model.overlay, model.login),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('wrapper oflwrap')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('innerwrapper oflwrap')
							]),
						_List_fromArray(
							[
